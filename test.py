...
def test():
    ...
    tau_score = tau1_score - tau2_score
    ...
    print("**Tau Score**\n")
    print("* Sort by tau1\n")
    print(df.sort_values(by="tau1", ascending=False).to_markdown(tablefmt="grid"))
    print()
    print("* Sort by tau2\n")
    print(df.sort_values(by="tau2", ascending=False).to_markdown(tablefmt="grid"))
    print()
